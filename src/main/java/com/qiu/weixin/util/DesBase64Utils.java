...
public class DesBase64Utils {
    ...
    public static void main(String args[]) {
        ...
        String res2 = DesBase64Utils.encrypt2(str, password);
        System.out.println("加密后：" + res2);
        res2 = "ZDeZdU4%2FKfDBRd0Ls77xeidLmyQIqjSRz1%2BCH%2Bu5O8EVo3B9IXhFTb4mSHzHgsItH10V%2B8MR0poHJtp%2BiymdxbBa8mB%2Fi%2FFLIT8OXK04c5doTtIaySgRkGeixvTJbBAlflJq35BrxxsiAl68HuqlKx4iglrzajw%2BCZSrIoBoccy%2BKEWduBpNszB511LlgpGda9HJy%2FmzdQgvjAGC5gFJ1Nb37hxcakvTSQML9ecMuWjkHD4kWirvo9%2FxGLVhoyPIEjfjk3GQNoEqabWVx%2Fd19EPlML6Ez%2BOdaiWWIIk1Cyp%2BYZ2KkmN4sS12hyx0DPaJF2MkKhYHIB%2BeZIubhoe77j26QPR6GdLKA4azPObSrHn6ehJgwHHILI4HIlHJS%2Bacr%2F2CXIUFy0w%3D";


        // 直接将如上内容解密
        try {
            //res2 = "";
//			res2="/7gCTFyYmnpeuuGEMzEPCX+VU6vZWabLXkAQJZ0OiJ8=";
            System.out.println("解密后2：" + DesBase64Utils.decrypt2(res2, password));
        } catch (Exception e1) {
            e1.printStackTrace();
        }
