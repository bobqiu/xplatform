package com.qiu.authority.config.listener;
...
public class ApplicationEventListener implements ApplicationListener<ApplicationEvent> {
    ...
    private static final org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger(ApplicationEventListener.class);
