        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <form method="post" action="${ctx!}/admin/login" id="frm">
                    ...
                    <input type="text" class="form-control uname" name="username" id="username" placeholder="用户名" value="admin" />
                    <input type="password" class="form-control pword m-b" name="password" id="password" value="admin" placeholder="密码" />
