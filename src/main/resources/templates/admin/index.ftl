                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">XPlatformqq</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                <i class="fa fa-user"></i> <span class="label label-primary"></span>【<@shiro.principal type="com.qiu.authority.entity.User" property="nickName"/>】
                            </a>
                                ...
                                <li>
                                    <a href="${ctx!}/admin/logout">
                                        <div>
                                            ...
                                            <span class="pull-right text-muted small"><@shiro.principal type="com.qiu.authority.entity.User" property="userName"/></span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
